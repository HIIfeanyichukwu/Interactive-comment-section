...
- Solution URL: [code](https://github.com/interactive-comment-section)
- Live Site URL: [demo](https://comments-section.surge.sh)
...
I learned a little about vite build options.
